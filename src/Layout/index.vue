<template>
  <main class="app-wrapper">
    <InitialAdminBanner v-if="isAuthenticated" :auto-check="true" />
    ...
    <div
      class="transition-all duration-150 content-wrapper"
...
import InitialAdminBanner from "@/modules/auth/components/InitialAdminBanner.vue";
